<%@ Page Title="Program Courses" Language="C#" MasterPageFile="~/School/Shared/Base.master" AutoEventWireup="true" CodeFile="ProgramCourse.aspx.cs" Inherits="School.AcademicRegistrar.ProgramCourse" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
        ...
        <telerik:RadSplitter runat="server" ID="RadSplitter1" Height="100%" Width="100%" Orientation="Horizontal">
            <telerik:RadPane ID="GridPane" runat="server" Height="27px" Scrolling="None">
                <h4>Program Course List</h4>
            </telerik:RadPane>

            <telerik:RadPane ID="RadPane2" runat="server" Height="55%" Scrolling="None">
                <telerik:RadGrid ID="Grid" DataSourceID="LinqDataSourceProgramCourse" runat="server" PageSize="20" AutoGenerateColumns="false" AllowPaging="true"
                    ...
                    <MasterTableView DataSourceID="LinqDataSourceProgramCourse" TableLayout="Fixed" DataKeyNames="ProgramCourseId">
                        <Columns>
                            <telerik:GridBoundColumn
                                HeaderText="No" DataField="ProgramCourseId" SortExpression="ProgramCourseId" UniqueName="ProgramCourseId"
                ...
                <asp:LinqDataSource ID="LinqDataSourceProgramCourse" runat="server" ContextTypeName="Erp2016.Lib.linqViewDataContext" EntityTypeName="" TableName="vwProgramCourses" OrderBy="CreatedDate DESC" />
            </telerik:RadPane>
                        ...
                        <div class="formStyle3">
                            ...
                            <fieldset>
                                ...
                                <div>
                                    ...
                                    <telerik:RadTextBox ID="RadTextBoxProgramCourse" CssClass="RadSizeLarge" runat="server" />
                                    <br style="clear: both;" />
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="RadTextBoxProgramCourse" Display="Dynamic" ErrorMessage="Course Required" ForeColor="Red" ValidationGroup="Info" />
                                </div>
                                <div>

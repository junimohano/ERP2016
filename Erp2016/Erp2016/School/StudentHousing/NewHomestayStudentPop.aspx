<%@ Page Title="" Language="C#" MasterPageFile="~/School/Shared/BasePop.master" AutoEventWireup="true" CodeFile="NewHomestayStudentPop.aspx.cs" Inherits="School_Registrar_Student_NewHomesayStudentPop" %>
        ...
        <telerik:RadSplitter runat="server" ID="RadSplitter1" Height="100%" Width="100%" Orientation="Horizontal">
            ...
            <telerik:RadPane ID="RadpaneBasic" runat="server" Height="40px" Scrolling="None">
                <telerik:RadToolBar ID="UpdateToolBar" runat="server" OnButtonClick="UpdateToolBar_ButtonClick" OnClientButtonClicking="ToolbarButtonClick">
                    <Items>
                        <telerik:RadToolBarButton ImageUrl="~/assets/img/bt_save.png" Text="Save Homestay Placement" ToolTip="Save" ValidationGroup="Info" />
                    ...
                    <telerik:RadPane ID="Radpane1" runat="server" Width="68%">
                        ...
                        <table width="96%" border="0" cellpadding="1" cellspacing="1" frame="border">
                            ...
                            <tr>
                                ...
                                <td class="auto-styleTxt">
                                    <telerik:RadDatePicker ID="DatePickArrivalDate" runat="server" Culture="en-US" Height="25px" MinDate="1900-01-01" Width="160px" AutoPostBack="True" OnSelectedDateChanged="DatePickArrivalDate_SelectedDateChanged">
                                        <Calendar EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                                        </Calendar>
                                        <DateInput DateFormat="MM-dd-yyyy" DisplayDateFormat="MM-dd-yyyy" Height="25px" LabelWidth="40%" AutoPostBack="True">
                        ...
                        <table width="96%" border="0" cellpadding="1" cellspacing="1" frame="border" style="margin-bottom: 0px">
                            ...
                            <tr>
                                ...
                                <td class="auto-styleTxt">
                                    <telerik:RadTextBox ID="TxtHomestayWeeks" runat="server" Width="160px" Text="0" Enabled="false">
                                    </telerik:RadTextBox>
                            ...
                            <tr>
                                <td class="auto-style2" colspan="8">
                                    ...
                                    <telerik:RadGrid ID="Grid_ChangeList" runat="server" Visible="false" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" GroupPanelPosition="Top" CellSpacing="-1" GridLines="Both" OnItemDataBound="Grid_ChangeList_ItemDataBound" OnNeedDataSource="Grid_ChangeList_NeedDataSource">
                                        ...
                                        <MasterTableView DataKeyNames="HomestayCancelSchdeduleId">
                                            <Columns>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ToolbarButtonClick(sender, args) {
                ...
                if (button.get_text() == "Save Homestay Placement Request") {
                    if (!confirm('Do you want to Save Homestay Placement Request it?'))

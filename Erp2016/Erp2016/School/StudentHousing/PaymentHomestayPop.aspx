<%@ Page Title="" Language="C#" MasterPageFile="~/School/Shared/BasePop.master" AutoEventWireup="true" CodeFile="PaymentHomestayPop.aspx.cs" Inherits="School_StudentHousing_PaymentHomestayPop" %>
            ...
            <telerik:RadPane ID="Radpane5" runat="server" Scrolling="None">
                <telerik:RadSplitter runat="server" ID="RadSplitter2" Orientation="Horizontal">
                    <telerik:RadPane ID="Radpane1" runat="server" Height="150px">
                        <telerik:RadLabel runat="server" ID="lblhostlist" Text="Homestay Invoice "></telerik:RadLabel>

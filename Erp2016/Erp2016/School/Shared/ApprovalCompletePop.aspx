<%@ Page Title="Approval Complete" Language="C#" MasterPageFile="~/School/Shared/BasePop.master" AutoEventWireup="true" CodeFile="ApprovalCompletePop.aspx.cs" Inherits="School.Shared.ApprovalCompletePop" %>
        ...
        <telerik:RadSplitter runat="server" ID="RadSplitter1" Height="100%" Width="100%" Orientation="Horizontal">
            <telerik:RadPane ID="RadpaneBasic" runat="server" Height="100%" Scrolling="Y" Width="100%">
                <telerik:RadToolBar ID="MainToolBar" runat="server" OnButtonClick="MainToolBar_ButtonClick" OnClientButtonClicking=" ToolbarButtonClick ">
                    <Items>
                        <telerik:RadToolBarButton ImageUrl="../../assets/img/bt_save.png" Text="Complete" Value="Complete" ToolTip="Complete" ValidationGroup="Info" />
                ...
                <div class="formStyle3">
                    ...
                    <div style="float: left; width: 100%;">
                        <fieldset>
                            ...
                            <div style="float: left; width: 100%;">
                                <telerik:RadTextBox runat="server" Width="100%" ID="RadTextBoxCheckNo" />
                            </div>
                        </fieldset>
                    </div>
                </div>

...
namespace School.OfficeAdmin
{
    ...
    {
        public Vacation() : base((int)CConstValue.Menu.Vacation)
        {
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LinqDataSourceApproval.Where = "ApprovalUser == @ApprovalUser && IsApprovalRequest == @IsApprovalRequest && CreatedId != @ApprovalUser";
            //}
        }
        ...
        protected void RadGrid_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            RunClientScript("ShowNewPop('" + grid.SelectedValues["VacationId"] + "', '1', '" + gridType + "', '" + approvalType + "');");
        }

        protected void ToolbarButtonClicked(object sender, RadToolBarEventArgs e)
        {
            if (e.Item.Text == "New Vacation")
            {
                RunClientScript("ShowNewPop('0', '0', '0', '0');");
            }
            //else if (e.Item.Text == "Vacation Detail")
            //{
            //    RunClientScript("ShowInfoPop('" + RadGridRequest.SelectedValues["No"] + "');");
            //}
        }

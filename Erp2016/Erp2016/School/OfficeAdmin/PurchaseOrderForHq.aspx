<%@ Page Title="Purchase Order for HQ" Language="C#" MasterPageFile="~/School/Shared/Base.master" AutoEventWireup="true" CodeFile="PurchaseOrderForHq.aspx.cs" Inherits="School.OfficeAdmin.PurchaseOrderForHq" %>
        ...
        <telerik:RadSplitter runat="server" ID="RadSplitter1" Height="100%" Width="100%" Orientation="Horizontal" ResizeMode="EndPane">
            ...
            <telerik:RadPane ID="Radpane1" runat="server" Scrolling="None">
                ...
                <asp:LinqDataSource ID="LinqDataSourceHq" runat="server"
                    ...
                    TableName="vwPurchaseOrderHqLists" OrderBy="CreatedDate Descending"
                    Where="No == @No">
                    <WhereParameters>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ShowNewPop(expenseId, createOrListType, requestOrApprovalType, approvalType) {
                var oWnd = window.radopen('PurchaseOrderPop?id=' + expenseId + '&createOrListType=' + createOrListType + '&requestOrApprovalType=' + requestOrApprovalType + '&approvalType=' + approvalType + '', 0, 0, 0, 0);

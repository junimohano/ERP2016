...
{
    public partial class CorporateCreditCard : PageBase
    {
        public CorporateCreditCard() : base((int)CConstValue.Menu.CorporateCreditCard)
        {
        }
        ...
        protected void RadGrid_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            RunClientScript("ShowNewPop('" + grid.SelectedValues["CorporateCreditCardId"] + "', '1', '" + gridType + "', '" + approvalType + "');");
        }

        protected void ToolbarButtonClicked(object sender, RadToolBarEventArgs e)
        {
            if (e.Item.Text == "New Corporate Credit Card")
            {

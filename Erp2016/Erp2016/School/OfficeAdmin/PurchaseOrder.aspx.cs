...
{
    public partial class PurchaseOrder : PageBase
    {
        public PurchaseOrder() : base((int)CConstValue.Menu.PurchaseOrder)
        {
        }
        ...
        protected void RadGrid_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            RunClientScript("ShowNewPop('" + grid.SelectedValues["PurchaseOrderId"] + "', '1', '" + gridType + "', '" + approvalType + "');");
        }

        protected void ToolbarButtonClicked(object sender, RadToolBarEventArgs e)
        {
            if (e.Item.Text == "New Purchase Order")
            {

...
{
    public partial class CorporateCreditCardForHq : PageBase
    {
        public CorporateCreditCardForHq() : base((int)CConstValue.Menu.CorporateCreditCardForHq)
        {
        }
        ...
        //    var tempDt = expense.GetExpenseDetailList((int)CConstValue.ApprovalStatus.Approved);

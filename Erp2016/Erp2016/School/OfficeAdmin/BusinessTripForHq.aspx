<%@ Page Title="Business Trip For HQ" Language="C#" MasterPageFile="~/School/Shared/Base.master" AutoEventWireup="true" CodeFile="BusinessTripForHq.aspx.cs" Inherits="School.OfficeAdmin.BusinessTripForHq" %>
        ...
        <telerik:RadSplitter runat="server" ID="RadSplitter1" Height="100%" Width="100%" Orientation="Horizontal" ResizeMode="EndPane">
            ...
            <telerik:RadPane ID="Radpane1" runat="server" Scrolling="None">
                ...
                <asp:LinqDataSource ID="LinqDataSourceHq" runat="server"
                    ...
                    TableName="vwBusinessTripHqLists" OrderBy="CreatedDate Descending"
                    Where="No == @No">
                    <WhereParameters>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ShowNewPop(expenseId, createOrListType, requestOrApprovalType, approvalType) {
                var oWnd = window.radopen('BusinessTripPop?id=' + expenseId + '&createOrListType=' + createOrListType + '&requestOrApprovalType=' + requestOrApprovalType + '&approvalType=' + approvalType + '', 0, 0, 0, 0);

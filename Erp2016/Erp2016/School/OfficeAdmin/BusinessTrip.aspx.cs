...
namespace School.OfficeAdmin
{
    ...
    {
        public BusinessTrip() : base((int)CConstValue.Menu.BusinessTrip)
        {
        }
        ...
        protected void RadGrid_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            RunClientScript("ShowNewPop('" + grid.SelectedValues["BusinessTripId"] + "', '1', '" + gridType + "', '" + approvalType + "');");
        }

        protected void ToolbarButtonClicked(object sender, RadToolBarEventArgs e)
        {
            if (e.Item.Text == "New Business Trip")
            {

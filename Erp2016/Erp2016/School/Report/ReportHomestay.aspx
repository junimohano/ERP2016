<%@ Page Title="" Language="C#" MasterPageFile="~/School/Shared/BasePop.master" AutoEventWireup="true" CodeFile="ReportHomestay.aspx.cs" Inherits="School_Report_ReportHomestay" %>
     ...
     <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
        ...
        <telerik:RadSplitter runat="server" ID="RadSplitter2" Height="100%" Width="100%" Orientation="Horizontal">
            ...
            <telerik:RadPane ID="Radpane3" runat="server" Scrolling="None" BackColor="White">
                <telerik:ReportViewer ID="RV_Homestay" runat="server" Height="100%" Width="100%" />
            </telerik:RadPane>

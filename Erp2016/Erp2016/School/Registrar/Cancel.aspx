<%@ Page Title="Cancel" Language="C#" MasterPageFile="~/School/Shared/Base.master" AutoEventWireup="true" CodeFile="Cancel.aspx.cs" Inherits="School.Registrar.Cancel" %>
        ...
        <telerik:RadSplitter runat="server" ID="RadSplitter1" Height="100%" Width="100%" Orientation="Horizontal" ResizeMode="EndPane">
            ...
            <telerik:RadPane ID="Radpane3" runat="server" Height="50%" Scrolling="None">
                ...
                <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" PageSize="30" DataSourceID="LinqDataSource1" Height="100%"
                    ...
                    <MasterTableView DataKeyNames="CancelId" TableLayout="Fixed" DataSourceID="LinqDataSource1" AllowMultiColumnSorting="True">
                        <Columns>
                            <telerik:GridBoundColumn
                                HeaderText="No" DataField="CancelId" SortExpression="CancelId" UniqueName="CancelId"
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server"
                    ...
                    TableName="vwCancels" OrderBy="CreatedDate Descending"
                    Where="CancelId == @CancelId">
                    <WhereParameters>
                        <asp:Parameter DefaultValue="0" Name="CancelId" Type="Int32" />
                    </WhereParameters>
                </asp:LinqDataSource>
                ...
                <div class="formStyle3">
                    <fieldset>
                        ...
                        <div style="float: left; width: 100%;">
                            <label>Apply Date</label><telerik:RadDatePicker DateInput-DisplayDateFormat="MMM dd, yyyy" ID="RadDatePickerApplyDate" runat="server" CssClass="RadSizeMiddle" MinDate="01/01/1900" MaxDate="01/01/3000"></telerik:RadDatePicker>
                            <br style="clear: both;" />
                        </div>

<%@ Page Title="Transfer" Language="C#" MasterPageFile="~/School/Shared/Base.master" AutoEventWireup="true" CodeFile="Transfer.aspx.cs" Inherits="School.Registrar.Transfer" %>
        ...
        <telerik:RadSplitter runat="server" ID="RadSplitter1" Height="100%" Width="100%" Orientation="Horizontal" ResizeMode="EndPane">
            ...
            <telerik:RadPane ID="Radpane3" runat="server" Height="40%" Scrolling="None">
                ...
                <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" PageSize="30" DataSourceID="LinqDataSource1" Height="100%"
                    ...
                    <MasterTableView DataKeyNames="TransferId" TableLayout="Fixed" DataSourceID="LinqDataSource1" AllowMultiColumnSorting="True">
                        <Columns>
                            <telerik:GridBoundColumn
                                HeaderText="No" DataField="TransferId" SortExpression="TransferId" UniqueName="TransferId"
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server"
                    ...
                    TableName="vwTransfers" OrderBy="CreatedDate Descending"
                    Where="TransferId == @TransferId">
                    <WhereParameters>
                        <asp:Parameter DefaultValue="0" Name="TransferId" Type="Int32" />
                    </WhereParameters>
                </asp:LinqDataSource>

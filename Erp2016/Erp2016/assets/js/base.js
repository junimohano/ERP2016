function AlertDialoge(content, width, height, title) {
    //radalert(content, width, height, title);
    alert(content, width, height, title);
}
...
function InitNiceScroll() {
    ...
    $('#RAD_SPLITTER_PANE_CONTENT_LeftPane').niceScroll('#nav');
